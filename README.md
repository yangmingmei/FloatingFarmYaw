...
6. run [train_29_turbines.py](train_29_turbines.py) or [train_63_turbines.py](train_63_turbines.py) to train a DRL agent for floating wind farm yaw control (it only take 3 hours when using massively parallel simulations). 
