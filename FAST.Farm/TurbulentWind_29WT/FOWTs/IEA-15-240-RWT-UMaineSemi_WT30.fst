...
---------------------- INPUT FILES --------------------------------------------- 
"IEA-15-240-RWT-UMaineSemi_ElastoDyn30.dat"             EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
...
"InflowWind_WT30.dat"             InflowFile      - Name of file containing inflow wind input parameters (quoted string)
"../../CommonFiles/Rotor/IEA-15-240-RWT-UMaineSemi_AeroDyn15.dat"    AeroFile     - Name of file containing aerodynamic input parameters (quoted string)
"IEA-15-240-RWT-UMaineSemi_ServoDyn_WT30.dat"             ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
"../../CommonFiles/IEA-15-240-RWT-UMaineSemi_HydroDyn.dat"    HydroFile       - Name of file containing hydrodynamic input parameters (quoted string)
"none"        SubFile         - Name of file containing sub-structural input parameters (quoted string) 
"../../CommonFiles/IEA-15-240-RWT-UMaineSemi_MoorDyn.dat"    MooringFile     - Name of file containing mooring system input parameters (quoted string)
