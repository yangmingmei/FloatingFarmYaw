...
---------------------- INPUT FILES --------------------------------------------- 
"IEA-15-240-RWT-UMaineSemi_ElastoDyn25.dat"             EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
...
"InflowWind_WT25.dat"             InflowFile      - Name of file containing inflow wind input parameters (quoted string)
...
"IEA-15-240-RWT-UMaineSemi_ServoDyn_WT25.dat"             ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
